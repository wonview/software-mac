...
#define M2_RXEVENT                          4
#define HOST_CMD                            5
#define HOST_CMD_RESP                       5
#define HOST_EVENT                          6
#define TEST_CMD                          	7

#define M0_HDR_LEN							4
#define M0_HDR_LEN_MAX						(M0_HDR_LEN+IEEE80211_HT_CTL_LEN+IEEE80211_QOS_CTL_LEN+ETHER_ADDR_LEN+2)
...
typedef struct PKT_TxInfo_st
{
	...
	/* The definition of WORD_4: */
	u32				rts_cts_nav:16;
	u32				frame_consume_time:9;	//32 units
	u32				more_txop:1;
	u32				crate_idx:6;
...
#define  EXTRA_LEN								36
#define  CABRIO_ETH_TX_PACKET_BUFFER_SIZE		(ETH_FRAME_LEN + RX_M0_HDR_LEN)
#define  CABRIO_ETH_RX_PACKET_BUFFER_SIZE       (ETH_FRAME_LEN + RX_M0_HDR_LEN + CABRIO_SNAP_HEADER_LEN + EXTRA_LEN)
