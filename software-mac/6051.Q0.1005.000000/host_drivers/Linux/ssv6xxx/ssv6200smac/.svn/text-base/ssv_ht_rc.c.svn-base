...
{
/*
    MCS0-l[duration[5664] MCS1-l[duration[5664] MCS2-l[duration[5664] MCS3-l[duration[5696]
    MCS4-l[duration[5684] MCS5-l[duration[5696] MCS6-l[duration[5692] MCS7-l[duration[5688]

    MCS0-s[duration[5652] MCS1-s[duration[5652] MCS2-s[duration[5688] MCS3-s[duration[5678]
    MCS4-s[duration[5688] MCS5-s[duration[5692] MCS6-s[duration[5688] MCS7-s[duration[5685]
*/
    //B mode
    0, 0, 0, 0, 0, 0, 0,
    //G mode
    0, 0, 0, 0, 0, 0, 0, 0,
    //Long GI max transmit length
    4600, 9200, 13800, 18500, 27700, 37000, 41600, 46200,
    //Short GI max transmit length
    5100, 10200, 15400, 20500, 30800, 41100, 46200, 51300,
    //Green field max transmit length
    4600, 9200, 13800, 18500, 27700, 37000, 41600, 46200
};
...
*/
    ...
    for (i = 0; !last; i++) {
        ...
        if((report_data->rates[i].data_rate < SSV62XX_RATE_MCS_INDEX) || (report_data->rates[i].data_rate >= SSV62XX_RATE_MCS_GREENFIELD_INDEX)) {
            printk("[RC]ssv6xxxx_ht_report_handler get error report rate[%d]\n",report_data->rates[i].data_rate);
            break;
        }
#endif
